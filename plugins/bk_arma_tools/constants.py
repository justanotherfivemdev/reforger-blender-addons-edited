...
WEAPON_BONE_TYPES = [
    ...
    ('w_sear_release', "Sear Release", "Sear release bone"),
    ('w_receiver', "Receiver", "Receiver bone"),
    ...
    ('w_sight', "Sight", "Rear sight bone"),
    ('w_sight_slider', "Sight Slider", "Sight slider bone"),
    ('w_sight_front', "Sight Front", "Front sight bone"),
    ('w_topcover', "Top Cover", "Top cover bone (MGs)"),
    ('w_handle', "Handle", "Carry handle bone"),
    ('w_cartridge_handle', "Cartridge Handle", "Cartridge handle bone"),
    ...
    ('w_jiggle01', "Jiggle 01", "Jiggle physics bone 1"),
    ('w_jiggle02', "Jiggle 02", "Jiggle physics bone 2"),
    ('w_cylinder', "Cylinder", "Cylinder bone (revolvers)"),
    ('w_barrel', "Barrel", "Barrel bone"),
    ('w_ejection_port', "Ejection Port", "Ejection port bone"),
    ('w_tripod_holder_horizontal', "Tripod Horizontal", "Tripod horizontal holder bone"),
    ('w_tripod_holder_vertical', "Tripod Vertical", "Tripod vertical holder bone"),
    ('custom', "Custom Bone", "Add a custom bone"),
]
